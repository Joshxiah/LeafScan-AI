...
-- ============================================================
-- SECTION 7b: TABLE - reports
-- A farmer's outbreak report to the CAO: a snapshot of their own
-- recent scans (counts + a disease breakdown, computed on the
-- phone) plus an estimated affected area and free-text remarks.
-- ============================================================
